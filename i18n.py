"""
i18n.py — 한국어 / 영어 UI 문자열 번역 모듈

사용법:
    from i18n import t
    t("app_title", lang)   # lang = "ko" | "en"
"""
...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "ko": {
        ...
        "search_placeholder": (
            "예: AAPL, SPY, 005930, 삼성전자, 엔비디아, 도요타, 텐센트, TSMC, ASML"
        ),
        "analyze_btn":  "🔍 분석",
        ...
        "welcome":         "환영합니다",
        "logged_in_as":    "로그인: ",
        "oauth_not_configured": "OAuth 미설정 (secrets.toml에 키 추가 필요)",
        ...
        "footer": (
            ...
            "재무데이터는 yfinance 기준이라 실제 공시와 차이가 있을 수 있으니 "
            "투자 판단 시 원문 공시를 반드시 확인하세요."
        ),
    },
    ...
    "en": {
        ...
        "search_placeholder": (
            "e.g.: AAPL, SPY, Samsung, Nvidia, Toyota, Tencent, TSMC, ASML, 7203.T"
        ),
        "analyze_btn":  "🔍 Analyze",
        ...
        "oauth_not_configured": "OAuth not configured (add keys to secrets.toml)",
        ...
        # ── Footer ────────────────────────────────────────────
        "footer": (
            "⚠️ This tool is a prototype and not investment advice. "
            "Scores/grades are rule-based approximations. "
            "Financial data is sourced from yfinance and may differ from official filings."
        ),
    },
}
